...
let a = Infinity;
let b = NaN;
// Any operation on NaN return NaN except raise to the power 0 which is equal to 1

// 1/0 --> Infinity
// "not a number"/2 --> NaN
// NaN+12 --> NaN

// Maximium & Minimium in JS

Number.MAX_SAFE_INTEGER;
Number.MIN_SAFE_INTEGER;

// BigInt -> Numbers bigger than max integer or minimium
